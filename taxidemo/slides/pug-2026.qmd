...
%%| fig-width: 9
graph LR
    I1["Choice model<br/>parameters"] --> P
    I2["Network<br/>configuration"] --> P
    I3["Transit<br/>settings"] --> P
    P["POLARIS"] --> O["Network<br/>performance"]

    classDef box fill:#ffffff,stroke:#1a6fb5,stroke-width:1.5px,color:#1a3a5c;
    classDef model fill:#1a3a5c,stroke:#1a3a5c,stroke-width:1.5px,color:#ffffff;
    class I1,I2,I3,O box;
    class P model;
```

A single run costs **hours** and **60+ GB**. **PolarisOpt** chooses which inputs to run, for **calibration** and **exploration**.
